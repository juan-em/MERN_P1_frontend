...
const UserEditPage = () => {
  ...
  const [deleteUser,{ isSuccess: isDeleteSuccess, isError: isDeleteError, error: deleteError }] = useDeleteUserMutation();
  ...
  return (
    <div>
      ...
      <EditUserForm form={form} onSaveUser={onSaveUser} onDeleteUser={onDeleteUser}/>
